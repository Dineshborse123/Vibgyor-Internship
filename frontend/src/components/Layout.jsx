    ...
    <div className="app-layout">
      ...
      <aside className="sidebar">
        <div 
          ...
          onClick={() => navigate(isAdmin() ? '/dashboard' : '/products')}
          style={{ cursor: 'pointer' }}
        >
          <h2>⚡ NovaShop</h2>
          <span>Next-Gen Retail</span>
        </div>
          ...
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '350px', textAlign: 'center', padding: '2rem', borderTop: '4px solid var(--danger)' }}>
            {isAdmin() ? (
              <>
                ...
                <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '0.9rem', lineHeight: '1.5' }}>Are you sure you want to securely log out of the NovaShop Administrative Console?</p>
              </>
            ) : (
              <>
                <div style={{ fontSize: '3rem', marginBottom: '0.5rem' }}>👋</div>
                <h3 id="logout-title" style={{ marginBottom: '1rem', fontWeight: 'bold', color: 'var(--text-primary)' }}>Leaving so soon?</h3>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '0.9rem', lineHeight: '1.5' }}>Are you sure you want to log out of your NovaShop account?</p>
              </>
            )}
